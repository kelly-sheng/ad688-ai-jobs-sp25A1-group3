...
sample_jobs = [
    Row(MIN_YEARS_EXPERIENCE=10.0, SALARY_AVG=300000.0, STATE_NAME="Massachusetts", MIN_EDULEVELS=3.0, REMOTE_TYPE="Remote"),
    Row(MIN_YEARS_EXPERIENCE=5.0, SALARY_AVG=75000.0, STATE_NAME="Texas", MIN_EDULEVELS=0.0, REMOTE_TYPE="Onsite"),
    Row(MIN_YEARS_EXPERIENCE=10.0, SALARY_AVG=120000.0, STATE_NAME="Minnesota", MIN_EDULEVELS=2.0, REMOTE_TYPE="Hybrid"),
    Row(MIN_YEARS_EXPERIENCE=15.0, SALARY_AVG=150000.0, STATE_NAME="New York", MIN_EDULEVELS=2.0, REMOTE_TYPE="Remote"),
]
...
# ---------- Doc-friendly table (no changes to model/pipeline) ----------
pdf = results.toPandas()

# Light formatting
pdf["AI_prob"] = pdf["AI_prob"].round(3)                    # 0.000–1.000
pdf["MIN_YEARS_EXPERIENCE"] = pdf["MIN_YEARS_EXPERIENCE"].round(1)
pdf["MIN_EDULEVELS"] = pdf["MIN_EDULEVELS"].round(1)
pdf["SALARY_AVG"] = pdf["SALARY_AVG"].map(lambda x: f"${x:,.0f}")  # $300,000
